  ...
  resources: {
    en: {
      translation: {
        ...
        authRequiredUpload: "Please sign in before uploading a process.",
        signIn: "Sign in",
        signOut: "Sign out",
        createAccount: "Create account",
        loggedInAs: "User: {{username}}",
        authSignInTitle: "Sign in to upload",
        authCreateTitle: "Create account",
        authPopupHint: "You need an account before uploading a process.",
        authUsername: "Username",
        authPassword: "Password",
        authSubmitting: "Please wait...",
        authFillAllFields: "Enter both username and password.",
        authUsernameExists: "This username already exists.",
        authInvalidCredentials: "Invalid username or password.",
        switchToCreate: "Need an account?",
        switchToSignIn: "Have an account?",
        chatTitle: "Comments",
        chatHint: "Share comments to improve this process.",
        chatAssistantLabel: "Assistant",
        chatUserLabel: "You",
        chatPlaceholder: "Suggest an update to this process or its steps...",
        chatSend: "Post comment",
        authRequiredFeedback: "Sign in to post comments on this process.",
        noFeedYet: "No comments have been posted yet.",
        ownerFeedbackTitle: "Feedback from users",
        ownerFeedbackHint: "Review what users have sent about this process.",
        ownerOtherProcesses: "More from {{username}}",
        ownerNoOtherProcesses: "No other processes from this user yet.",
        editProcess: "Edit process",
        editProcessHint: "Update this process JSON. The process id must stay the same.",
        editProcessSuccess: "Process updated successfully.",
        editProcessError: "Could not save process updates. Please provide valid ProcessGuide JSON.",
        editProcessIdLocked: "Process id cannot be changed while editing.",
        saveChanges: "Save changes",
        cancel: "Cancel",
        chatWelcome: "Share a suggested update for {{title}}.",
    ...
    am: {
      translation: {
        ...
        authRequiredUpload: "ሂደት ለመጫን በመጀመሪያ ይግቡ።",
        signIn: "ግባ",
        signOut: "ውጣ",
        createAccount: "መለያ ፍጠር",
        loggedInAs: "ተጠቃሚ: {{username}}",
        authSignInTitle: "ለመጫን ይግቡ",
        authCreateTitle: "መለያ ይፍጠሩ",
        authPopupHint: "ሂደት ከመጫንዎ በፊት መለያ ያስፈልጋል።",
        authUsername: "የተጠቃሚ ስም",
        authPassword: "የይለፍ ቃል",
        authSubmitting: "እባክዎ ይጠብቁ...",
        authFillAllFields: "የተጠቃሚ ስምና የይለፍ ቃል ያስገቡ።",
        authUsernameExists: "ይህ የተጠቃሚ ስም አስቀድሞ አለ።",
        authInvalidCredentials: "የተጠቃሚ ስም ወይም የይለፍ ቃል ትክክል አይደለም።",
        switchToCreate: "መለያ የለዎትም?",
        switchToSignIn: "መለያ አለዎት?",
        chatTitle: "አስተያየቶች",
        chatHint: "ይህን ሂደት ለማሻሻል አስተያየት ያጋሩ።",
        chatAssistantLabel: "ረዳት",
        chatUserLabel: "እርስዎ",
        chatPlaceholder: "ስለዚህ ሂደት የማሻሻያ አስተያየት ይፃፉ...",
        chatSend: "አስተያየት ይላኩ",
        authRequiredFeedback: "በዚህ ሂደት ላይ አስተያየቶች ለመለጠፍ ይግቡ።",
        noFeedYet: "ገና ምንም አስተያየቶች አልተለጠፉም።",
        ownerFeedbackTitle: "ከተጠቃሚዎች የተላከ አስተያየት",
        ownerFeedbackHint: "ለዚህ ሂደት ተጠቃሚዎች የላኩትን አስተያየት ይመልከቱ።",
        ownerOtherProcesses: "ከ {{username}} ተጨማሪ",
        ownerNoOtherProcesses: "ከዚህ ተጠቃሚ ሌሎች ሂደቶች ገና የሉም።",
        editProcess: "ሂደት አርትዕ",
        editProcessHint: "ይህን የሂደት JSON ያዘምኑ። የሂደት id መቀየር አይቻልም።",
        editProcessSuccess: "ሂደቱ በተሳካ ሁኔታ ተዘምኗል።",
        editProcessError: "የሂደት ዝማኔ መቀመጥ አልተቻለም። ትክክለኛ ProcessGuide JSON ያቅርቡ።",
        editProcessIdLocked: "ሲያርትዑ የሂደት id መቀየር አይቻልም።",
