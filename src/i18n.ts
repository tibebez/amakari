  ...
  resources: {
    en: {
      translation: {
        ...
        chatTitle: "Suggest feedback",
        chatHint: "Share feedback to improve this process.",
        chatAssistantLabel: "Assistant",
        chatUserLabel: "You",
        chatPlaceholder: "Suggest an update to this process or its steps...",
        chatSend: "Post feedback",
        authRequiredFeedback: "Sign in to post feedback on this process.",
        noFeedYet: "No feedback has been posted yet.",
    ...
    am: {
      translation: {
        ...
        chatSend: "አስተያየት ላክ",
        authRequiredFeedback: "በዚህ ሂደት ላይ አስተያየት ለመስጠት ይግቡ።",
        noFeedYet: "ገና ምንም አስተያየት አልተላከም።",
